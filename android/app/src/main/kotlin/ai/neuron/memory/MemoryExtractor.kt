...
class MemoryExtractor @Inject constructor(
    ...
    private suspend fun extractAppPreference(command: String, steps: List<StepLog>) {
    ...
    private suspend fun extractWorkflow(command: String, steps: List<StepLog>, totalDurationMs: Long) {
