...
class IntentClassifier @Inject constructor() {
    ...
    companion object {
        ...
        private val DOMAIN_PATTERNS = mapOf(
    ...
    private fun estimateSteps(complexity: Complexity): Int = when (complexity) {
        Complexity.SIMPLE -> 1
    ...
    private fun tierForComplexity(complexity: Complexity): LLMTier = when (complexity) {
