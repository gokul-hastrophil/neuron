...
class LongTermMemoryTest {
    ...
    inner class Preferences {
        @Test
        fun should_insertPreference_when_keyNotExists() =
            runTest {
        ...
        @Test
        fun should_updatePreference_when_keyExists() =
            runTest {
        ...
        @Test
        fun should_returnValue_when_preferenceExists() =
            runTest {
        ...
        @Test
        fun should_returnNull_when_preferenceNotExists() =
            runTest {
        ...
        @Test
        fun should_deletePreference_when_exists() =
            runTest {
        ...
        @Test
        fun should_notThrow_when_deletingNonexistent() =
            runTest {
    ...
    inner class Workflows {
        @Test
        fun should_insertWorkflow_when_newTask() =
            runTest {
        ...
        @Test
        fun should_incrementSuccessCount_when_existingTaskSucceeds() =
            runTest {
                val existing =
                    AppWorkflow(
                        id = 1,
        ...
        @Test
        fun should_incrementFailCount_when_existingTaskFails() =
            runTest {
                val existing =
                    AppWorkflow(
                        id = 1,
        ...
        @Test
        fun should_returnCachedWorkflow_when_exists() =
            runTest {
        ...
        @Test
        fun should_returnNull_when_noCachedWorkflow() =
            runTest {
    ...
    inner class Contacts {
        @Test
        fun should_insertContact_when_new() =
            runTest {
        ...
        @Test
        fun should_updateContact_when_existing() =
            runTest {
        ...
        @Test
        fun should_findByCanonicalKey_when_exists() =
            runTest {
        ...
        @Test
        fun should_fallbackToSearch_when_canonicalKeyMissing() =
            runTest {
    ...
    inner class BulkOps {
        @Test
        fun should_clearAllTables_when_clearAllCalled() =
            runTest {
                memory.clearAll()
