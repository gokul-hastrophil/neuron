...
class LLMRouterTest {
    ...
    private val sensitiveTree = UITree(
        packageName = "net.one97.paytm",
        nodes = listOf(UINode(id = "main")),
    )

    private val successResponse = LLMResponse(
    ...
    fun setup() {
        ...
        clientManager = mockk()
        router = LLMRouter(sensitivityGate, clientManager)
    }
    ...
    inner class TierRouting {
        ...
        @Test
        fun should_routeToT1_when_simpleClassification() = runTest {
        ...
        @Test
        fun should_routeToT2_when_moderateClassification() = runTest {
            val classification = IntentClassification(
        ...
        @Test
        fun should_routeToT3_when_complexClassification() = runTest {
            val classification = IntentClassification(
    ...
    inner class SensitivityOverride {
        ...
        @Test
        fun should_forceT4_when_sensitivityGateTriggersOnPackage() = runTest {
            val classification = IntentClassification(
                complexity = Complexity.MODERATE,
                suggestedTier = LLMTier.T2,
            )
        ...
        @Test
        fun should_forceT4_when_passwordFieldDetected() = runTest {
            val passwordTree = UITree(
    ...
    inner class FallbackBehavior {
        ...
        @Test
        fun should_fallbackToT3_when_T2Fails() = runTest {
            val classification = IntentClassification(
                complexity = Complexity.MODERATE,
                suggestedTier = LLMTier.T2,
            )
        ...
        @Test
        fun should_returnError_when_allTiersFail() = runTest {
            val classification = IntentClassification(
                complexity = Complexity.MODERATE,
                suggestedTier = LLMTier.T2,
            )
    ...
    inner class TimeoutHandling {
        ...
        @Test
        fun should_respectTierLatencyBudget_when_routing() = runTest {
            val classification = IntentClassification(
                complexity = Complexity.MODERATE,
                suggestedTier = LLMTier.T2,
            )
